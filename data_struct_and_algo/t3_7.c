// 3.7 Write a function to multiply two polynomials. Use a linked list implementation.
...
int main() {
	...
	Polynomial* res = mulPolynomial(pa, pb);
	Polynomial* res2 = mulPolynomial2(pa, pb);
	Polynomial* res3 = mulPolynomial3(pa, pb);
	Polynomial* res4 = mulPolynomial4(pa, pb);
	printList(pa);
	printList(pb);
	printList(res);
	printList(res2);
